...
import { CreditCard, Calendar, AlertCircle, CheckCircle, XCircle, Users } from 'lucide-react';
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="font-medium">{subscription?.seats_used || 0}</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-muted-foreground">Seats available</span>
                <span className="font-medium text-primary">{seatsAvailable}</span>
              </div>
            </div>
